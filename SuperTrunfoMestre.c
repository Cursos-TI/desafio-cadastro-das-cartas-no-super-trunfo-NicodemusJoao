...
com duas variações , cada uma será associada a uma carta*/
    ...
    int resultadoPopulacao, resultadoArea, resultadoPib, resultadopontoTuristico, 
    resultadodenPopulacional, resultadopibCapita , resultadosuperPoder; //irá armazenar o resultado das comparações


    /*iniciando o programa aonde o usuário terá acesso e podera inserir os dados,
    ...
    mas utilizando as variaveis para a segunda carta*/
        ...
        resultadodenPopulacional = (denPopulacional1) < (denPopulacional2);
        resultadosuperPoder = superPoder1 > superPoder2;


    /*Finalizado a entrada de dados pelo usuário e o cálculo de Densidade, Pib per capita e o super poder, agora iremos 
    demonstrar as cartas cadastradas, e na saída de dados , no printf() deveremos utilizar os mesmos especificadores
     ...
     seguido da declaração da variável, no printf() nao será necessário o uso do &.  */  
         ...
         printf("Densidade Populacional: Carta %d venceu (%d)\n", resultadodenPopulacional ? 1 : 2, resultadodenPopulacional);
         printf("PIB per Capita: Carta %d venceu (%d)\n", resultadopibCapita ? 1 : 2, resultadopibCapita);
